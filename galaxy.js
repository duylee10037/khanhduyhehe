...
(function(_0x5295c3, _0x28348c) {
    ...
    while (!![]) {
        try {
            const _0x49cfbe = -parseInt(_0x391d63(0x2a1)) / 0x1 * (parseInt(_0x391d63(0x213)) / 0x2) + parseInt(_0x391d63(0x254)) / 0x3 * (parseInt(_0x391d63(0x2bb)) / 0x4) + -parseInt(_0x391d63(0x232)) / 0x5 * (parseInt(_0x391d63(0x1d1)) / 0x6) + -parseInt(_0x391d63(0x1db)) / 0x7 + parseInt(_0x391d63(0x283)) / 0x8 + parseInt(_0x391d63(0x1f2)) / 0x9 * (parseInt(_0x391d63(0x25c)) / 0xa) + parseInt(_0x391d63(0x286)) / 0xb;
            if (_0x49cfbe === _0x28348c)
                break;
            else
...
const renderer = new _0x275f13[(_0x207b43(0x28e))]({
    'antialias': !![]
});
...
function _0x35a6(_0x2abffe, _0x5b3928) {
    ...
    return _0x35a6 = function(_0x35a6d7, _0x4bc128) {
...
function createGlowMaterial(_0x2f8802, _0x44755c=0x80, _0x35d7c7=0.55) {
    ...
    _0x285973[_0x2b2118(0x24f)](0x0, _0x2f8802),
    _0x285973[_0x2b2118(0x24f)](0x1, 'rgba(0,0,0,0)'),
    _0x1f56ab[_0x2b2118(0x217)] = _0x285973,
    _0x1f56ab[_0x2b2118(0x2c1)](0x0, 0x0, _0x44755c, _0x44755c);
    const _0x386cb5 = new _0x275f13['CanvasTexture'](_0x4d576a)
      , _0x17be30 = new _0x275f13[(_0x2b2118(0x207))]({
        'map': _0x386cb5,
        'transparent': !![],
        'opacity': _0x35d7c7,
        'depthWrite': ![],
        'blending': _0x275f13[_0x2b2118(0x244)]
    });
...
scene[_0x207b43(0x2a0)](centralGlow);
...
const galaxyParameters = {
    ...
    'insideColor': new _0x275f13[(_0x207b43(0x276))](0xd63ed6),
    'outsideColor': new _0x275f13[(_0x207b43(0x276))](0x48b8b8)
};
function getHeartImagesFromURL() {
    ...
    if (_0x6fb5a7) {
        const _0x4279fd = decodeURIComponent(_0x6fb5a7)
          , _0x21433b = _0x4279fd[_0x321c35(0x22a)](',')[_0x321c35(0x1b8)](_0x41cf75 => _0x41cf75[_0x321c35(0x28b)]())[_0x321c35(0x29d)](Boolean);
        return _0x21433b;
    }
    return null;
}
const heartImages = getHeartImagesFromURL() || (
    ...
    Array.isArray(window.dataLove2Loveloom.data.images)
        ? window.dataLove2Loveloom.data.images
        : []
);
document[_0x207b43(0x1bb)]('DOMContentLoaded', () => {
    ...
    if (getHeartImagesFromURL()) {
        ...
        if (_0x287a1)
            _0x287a1[_0x41551e(0x1d8)][_0x41551e(0x1b7)] = _0x41551e(0x288);
    }
    ...
    _0x231e4d?.[_0x41551e(0x1bb)]('click', () => {
        ...
        const _0x214235 = _0x1d701c[_0x55011b(0x22a)](',')['map'](_0x5a41b5 => _0x5a41b5[_0x55011b(0x28b)]())[_0x55011b(0x29d)](Boolean)
        ...
        navigator['clipboard'][_0x55011b(0x2ba)](_0x9cb9a0)[_0x55011b(0x226)]( () => {
            alert('Đã\x20tạo\x20và\x20sao\x20chép\x20link:\x0a' + _0x9cb9a0);
        }
        )[_0x55011b(0x22c)](_0x256015 => {
            const _0x25f022 = _0x55011b;
            console[_0x25f022(0x229)](_0x25f022(0x2be), _0x256015),
            alert(_0x25f022(0x1dd) + _0x9cb9a0);
        }
        );
    }
    );
...
for (let i = 0x0; i < galaxyParameters['count']; i++) {
    ...
    if (radius < 0x1e && Math[_0x207b43(0x2aa)]() < 0.7)
        continue;
    const i3 = pointIdx * 0x3;
    positions[i3] = Math[_0x207b43(0x261)](totalAngle) * radius + randomX,
    positions[i3 + 0x1] = randomY,
    positions[i3 + 0x2] = Math[_0x207b43(0x1e1)](totalAngle) * radius + randomZ;
...
const galaxyMaterial = new _0x275f13[(_0x207b43(0x1cc))]({
    'uniforms': {
        ...
        'uSize': {
            'value': 0x32 * renderer[_0x207b43(0x20c)]()
        },
        'uRippleTime': {
            'value': -0x1
        },
...
function createNeonTexture(_0x3b740a, _0x1718cd) {
    ...
    _0x408cbe[_0x19619a(0x2bf)] = _0x408cbe[_0x19619a(0x27e)] = _0x1718cd * _0x2bbbbf,
    _0x408cbe[_0x19619a(0x1d8)][_0x19619a(0x2bf)] = _0x408cbe[_0x19619a(0x1d8)]['height'] = _0x1718cd + 'px';
    ...
    _0x1342c3 > 0x1 ? (_0xf6e159 = _0x1718cd,
    _0x1681fc = _0x1718cd / _0x1342c3,
    _0x1fa424 = 0x0,
    _0x781b82 = (_0x1718cd - _0x1681fc) / 0x2) : (_0x1681fc = _0x1718cd,
    ...
    return _0x1d24af['minFilter'] = _0x275f13[_0x19619a(0x1c4)],
...
for (let group = 0x0; group < numGroups; group++) {
    ...
    for (let i = 0x0; i < pointsPerGroup; i++) {
        ...
        const branchAngle = globalIdx % galaxyParameters[_0x207b43(0x29c)] / galaxyParameters[_0x207b43(0x29c)] * Math['PI'] * 0x2
          ...
          , totalAngle = branchAngle + spinAngle;
        groupPositions[idx] = Math[_0x207b43(0x261)](totalAngle) * radius + randomX,
        groupPositions[idx + 0x1] = randomY,
        groupPositions[idx + 0x2] = Math[_0x207b43(0x1e1)](totalAngle) * radius + randomZ;
    ...
    for (let i = 0x0; i < posAttr[_0x207b43(0x1f6)]; i++) {
        cx += posAttr['getX'](i),
        cy += posAttr[_0x207b43(0x27b)](i),
        cz += posAttr[_0x207b43(0x1e0)](i);
    }
    cx /= posAttr[_0x207b43(0x1f6)],
    cy /= posAttr[_0x207b43(0x1f6)],
    cz /= posAttr[_0x207b43(0x1f6)],
    groupGeometryNear[_0x207b43(0x2ae)](-cx, -cy, -cz),
    groupGeometryFar[_0x207b43(0x2ae)](-cx, -cy, -cz);
    ...
    img[_0x207b43(0x1be)] = () => {
        const _0x4cae57 = _0x207b43
          ...
          , _0x5cff9c = new _0x275f13[(_0x4cae57(0x1f1))]({
            'size': 1.8,
            'map': _0x40c84a,
            'transparent': ![],
            'alphaTest': 0.2,
          ...
          , _0x5e01cf = new _0x275f13['PointsMaterial']({
            'size': 1.8,
            'map': _0x40c84a,
            'transparent': !![],
            'alphaTest': 0.2,
            'depthWrite': ![],
            'blending': _0x275f13[_0x4cae57(0x244)],
            'vertexColors': !![]
        })
...
for (let i = 0x0; i < starCount; i++) {
    ...
    starPositions[i * 0x3 + 0x1] = (Math[_0x207b43(0x2aa)]() - 0.5) * 0x384,
    starPositions[i * 0x3 + 0x2] = (Math[_0x207b43(0x2aa)]() - 0.5) * 0x384;
}
starGeometry[_0x207b43(0x1bd)](_0x207b43(0x1c8), new _0x275f13[(_0x207b43(0x23b))](starPositions,0x3));
const starMaterial = new _0x275f13[(_0x207b43(0x1f1))]({
    'color': 0xffffff,
    'size': 0.7,
    'transparent': !![],
    'opacity': 0.7,
...
starField[_0x207b43(0x272)] = _0x207b43(0x290),
starField['renderOrder'] = 0x3e7,
scene[_0x207b43(0x2a0)](starField);
function _0x2d88() {
    const _0x4b32c4 = ['clip', 'clone', 'intersectObject', 'pitchAmplitude', 'SphereGeometry', 'closePath', '\x0a\x20\x20\x20\x20\x20\x20\x20\x20varying\x20vec2\x20vUv;\x0a\x20\x20\x20\x20\x20\x20\x20\x20void\x20main()\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vUv\x20=\x20uv;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_Position\x20=\x20projectionMatrix\x20*\x20modelViewMatrix\x20*\x20vec4(position,\x201.0);\x0a\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20', 'geometryNear', 'render', 'rgba(255,\x20200,\x20220,\x200.8)', 'userData', 'name', 'geometry', 'points', 'tiltAmplitude', 'Color', 'lerp', 'shadowBlur', 'data', 'lookAt', 'getY', 'ontouchstart', 'RingGeometry', 'height', 'materialFar', 'zoomSpeed', 'images', ',\x2080%,\x2050%,\x200.6)', '3430256tgmaCl', 'createElement', 'origin', '18077697NTxxvu', 'outsideColor', 'none', 'remove', 'domElement', 'trim', 'generate-link', 'maxDistance', 'WebGLRenderer', 'DoubleSide', 'starfield', 'autoRotate', 'updateProjectionMatrix', 'setFromPoints', 'ringTexts', 'Vector2', 'now', 'arcTo', 'getWorldDirection', '--vh', 'push', 'scale', 'arms', 'filter', 'clientX', 'charCodeAt', 'add', '514453HpwJRq', 'value', 'main-planet', 'font', 'measureText', 'ringRadius', 'floor', 'dataLove2Loveloom', 'textRings', 'random', 'pow', '\x0a\x20\x20\x20\x20\x20\x20\x20\x20varying\x20vec3\x20vColor;\x0a\x20\x20\x20\x20\x20\x20\x20\x20void\x20main()\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20//\x20Làm\x20cho\x20các\x20hạt\x20có\x20hình\x20tròn\x20thay\x20vì\x20hình\x20vuông\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20float\x20dist\x20=\x20length(gl_PointCoord\x20-\x20vec2(0.5));\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20if\x20(dist\x20>\x200.5)\x20discard;\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_FragColor\x20=\x20vec4(vColor,\x201.0);\x0a\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20', 'rotation', 'translate', 'restore', 'MeshBasicMaterial', 'container', 'portrait-mode', 'innerHeight', 'time', '\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20varying\x20vec3\x20vNormal;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20time;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20void\x20main()\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20float\x20intensity\x20=\x20pow(0.7\x20-\x20dot(vNormal,\x20vec3(0.0,\x200.0,\x201.0)),\x202.0);\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_FragColor\x20=\x20vec4(1.0,\x201.0,\x201.0,\x20intensity\x20*\x20(0.8\x20+\x20sin(time\x20*\x205.0)\x20*\x200.2));\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20\x20\x20\x20\x20', 'px\x20Arial,\x20sans-serif', 'innerWidth', '#f06292', 'setProperty', 'writeText', '44820SOMCUs', 'Shape', 'src', 'Không\x20thể\x20sao\x20chép:', 'width', 'ringMesh', 'fillRect', 'splice', 'CanvasTexture', 'click', 'radius', 'initialPosition', 'slice', 'CubicBezierCurve3', 'children', 'display', 'map', 'transparent', '#fff', 'addEventListener', 'BackSide', 'setAttribute', 'onload', 'lineTo', 'SRGBColorSpace', 'main-glow', 'crossOrigin', 'getContext', 'LinearFilter', 'color', 'save', '\x0a\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20uSize;\x0a\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20uTime;\x0a\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20uRippleTime;\x0a\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20uRippleSpeed;\x0a\x20\x20\x20\x20\x20\x20\x20\x20uniform\x20float\x20uRippleWidth;\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20varying\x20vec3\x20vColor;\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20void\x20main()\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20//\x20Lấy\x20màu\x20gốc\x20từ\x20geometry\x20(giống\x20hệt\x20vertexColors:\x20true)\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vColor\x20=\x20color;\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vec4\x20modelPosition\x20=\x20modelMatrix\x20*\x20vec4(position,\x201.0);\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20//\x20----\x20LOGIC\x20HIỆU\x20ỨNG\x20GỢN\x20SÓNG\x20----\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20if\x20(uRippleTime\x20>\x200.0)\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20float\x20rippleRadius\x20=\x20(uTime\x20-\x20uRippleTime)\x20*\x20uRippleSpeed;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20float\x20particleDist\x20=\x20length(modelPosition.xyz);\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20float\x20strength\x20=\x201.0\x20-\x20smoothstep(rippleRadius\x20-\x20uRippleWidth,\x20rippleRadius\x20+\x20uRippleWidth,\x20particleDist);\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20strength\x20*=\x20smoothstep(rippleRadius\x20+\x20uRippleWidth,\x20rippleRadius\x20-\x20uRippleWidth,\x20particleDist);\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20if\x20(strength\x20>\x200.0)\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vColor\x20+=\x20vec3(strength\x20*\x202.0);\x20//\x20Làm\x20màu\x20sáng\x20hơn\x20khi\x20sóng\x20đi\x20qua\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vec4\x20viewPosition\x20=\x20viewMatrix\x20*\x20modelPosition;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_Position\x20=\x20projectionMatrix\x20*\x20viewPosition;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20//\x20Dòng\x20này\x20làm\x20cho\x20các\x20hạt\x20nhỏ\x20hơn\x20khi\x20ở\x20xa,\x20mô\x20phỏng\x20hành\x20vi\x20của\x20PointsMaterial\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_PointSize\x20=\x20uSize\x20/\x20-viewPosition.z;\x0a\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20', 'position', 'Points', 'requestFullscreen', '#ffffff', 'ShaderMaterial', 'fillText', 'cjk', '#f8bbd0', 'rollPhase', '162RSqNBZ', 'pitchPhase', 'anisotropy', 'visible', 'moveTo', 'randomness', 'forEach', 'style', '\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20varying\x20vec3\x20vNormal;\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20void\x20main()\x20{\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20vNormal\x20=\x20normalize(normalMatrix\x20*\x20normal);\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20gl_Position\x20=\x20projectionMatrix\x20*\x20modelViewMatrix\x20*\x20vec4(position,\x201.0);\x0a\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20}\x0a\x20\x20\x20\x20\x20\x20\x20\x20', 'join', '2628927zFXnIL', 'initialAngle', 'Đã\x20tạo\x20link\x20nhưng\x20không\x20thể\x20sao\x20chép.\x20Bạn\x20có\x20thể\x20copy\x20thủ\x20công:\x0a', 'type', 'trail', 'getZ', 'sin', '\x20\x20\x20', 'colorSpace', ',\x20Điểm\x20mỗi\x20ảnh:\x20', 'Image', 'rollAmplitude', 'curve', 'classList', 'alphabetic', 'intersectObjects', 'DOMContentLoaded', 'traverse', 'spin', 'Raycaster', '#3fd8c7', 'head', 'PointsMaterial', '9KqYNxh', 'opacity', 'multiplyScalar', 'isPoints', 'count', 'PerspectiveCamera', 'geometryFar', 'isGroup', 'copy', 'parent', 'setPixelRatio', 'getX', 'getBoundingClientRect', 'object', 'Scene', 'rotateSpeed', 'trailPoints', 'max', 'fontScale', 'ceil', 'speed', 'SpriteMaterial', 'spacingScale', 'life', 'vertexShader', 'CylinderGeometry', 'getPixelRatio', 'documentElement', 'shadowColor', 'left', 'uniforms', 'normalize', 'Vector3', '2oenmsM', 'Chạm\x20Vào\x20Tinh\x20Cầu', 'setFromCamera', 'BufferGeometry', 'fillStyle', 'repeat', 'log', '#f48fb1', 'bold\x20', 'beginPath', 'textBaseline', 'webkitRequestFullscreen', 'search', 'Group', 'setDrawRange', 'latin', 'set', 'getElementById', 'enabled', 'then', 'maxLife', 'getMaxAnisotropy', 'error', 'split', 'capabilities', 'catch', '#ffb3de', 'FogExp2', 'trailLength', 'other', 'Line', '241340FkMZFp', 'rollSpeed', 'strokeText', 'touchmove', 'length', '#b2ff59', 'TextureLoader', 'RepeatWrapping', 'lineWidth', 'BufferAttribute', 'strokeStyle', 'ShapeGeometry', 'body', 'setSize', 'orientationchange', 'hsla(', 'progress', 'Mesh', 'AdditiveBlending', 'aspect', 'isTextRing', 'get', 'clientY', 'pitchSpeed', 'material', 'middle', 'pathname', 'bezierCurveTo', 'rgba(220,\x20180,\x20255,\x200.5)', 'addColorStop', 'getAttribute', 'fog', 'tiltSpeed', 'materialNear', '111fRZlMO', '?images=', '#e0b3ff', 'resize', 'tiltPhase', '#a259f7', 'angleOffset', 'blur(2px)', '4851370kIXBAO', 'canvas', 'update', 'location', 'white', 'cos', 'fragmentShader', 'stroke', 'enablePan', 'target', 'createRadialGradient'];
    _0x2d88 = function() {
        return _0x4b32c4;
    }
    ;
...
function createShootingStar() {
    const _0x5f12df = _0x207b43
      ...
      , _0x638fc = new _0x275f13[(_0x5f12df(0x2b0))]({
        'color': 0xffffff,
        'transparent': !![],
        'opacity': 0x0,
    ...
    const _0x2d31c0 = new _0x275f13[(_0x5f12df(0x216))]()[_0x5f12df(0x293)](_0x33cdfa)
      , _0x48001c = new _0x275f13['LineBasicMaterial']({
        'color': 0x99eaff,
        'transparent': !![],
        'opacity': 0.7,
        'linewidth': 0x2
    ...
    _0x5b9de2[_0x5f12df(0x271)] = {
        'curve': _0x3875f5,
        'progress': 0x0,
        'speed': 0.001 + Math[_0x5f12df(0x2aa)]() * 0.001,
        'life': 0x0,
        'maxLife': 0x12c,
        'head': _0x3455d8,
        'trail': _0x3f9d2c,
        'trailLength': _0x2a509b,
...
function createRandomCurve() {
    ...
    return _0x49dd1a[_0x550279(0x29a)](_0x66bac8, _0x5b831b, _0x247db0, _0x3977c3),
    new _0x275f13[(_0x550279(0x1b5))](_0x66bac8,_0x5b831b,_0x247db0,_0x3977c3);
}
function createPlanetTexture(_0x5e2c16=0x200) {
    ...
    for (let _0x3ea16b = 0x0; _0x3ea16b < 0x28; _0x3ea16b++) {
        ...
        _0x421de0[_0x2c6189(0x24f)](0x0, _0x128e7a + 'cc'),
        _0x421de0[_0x2c6189(0x24f)](0x1, _0x128e7a + '00'),
        _0xd01be7[_0x2c6189(0x217)] = _0x421de0,
        _0xd01be7['fillRect'](0x0, 0x0, _0x5e2c16, _0x5e2c16);
    }
    for (let _0x47e4d0 = 0x0; _0x47e4d0 < 0x8; _0x47e4d0++) {
        ...
        _0xd01be7[_0x2c6189(0x24d)](Math['random']() * _0x5e2c16, Math['random']() * _0x5e2c16, Math[_0x2c6189(0x2aa)]() * _0x5e2c16, Math[_0x2c6189(0x2aa)]() * _0x5e2c16, Math[_0x2c6189(0x2aa)]() * _0x5e2c16, Math[_0x2c6189(0x2aa)]() * _0x5e2c16),
    ...
    return _0xd01be7[_0x2c6189(0x29d)] !== undefined && (_0xd01be7[_0x2c6189(0x29d)] = _0x2c6189(0x25b),
    _0xd01be7['drawImage'](_0x587670, 0x0, 0x0),
    _0xd01be7[_0x2c6189(0x29d)] = _0x2c6189(0x288)),
...
const stormShader = {
  ...
  , planetMaterial = new _0x275f13[(_0x207b43(0x1cc))]({
    ...
    'vertexShader': stormShader[_0x207b43(0x20a)],
    'fragmentShader': stormShader[_0x207b43(0x262)]
})
  , planet = new _0x275f13[(_0x207b43(0x243))](planetGeometry,planetMaterial);
planet[_0x207b43(0x1c8)][_0x207b43(0x223)](0x0, 0x0, 0x0),
scene[_0x207b43(0x2a0)](planet);
    ...
    for (let _0x51465e = 0x0; _0x51465e < _0x38a806; _0x51465e++) {
        ...
        function _0x2580ef(_0x2fd8ca) {
            ...
            if (_0x4b5de8 >= 0x4e00 && _0x4b5de8 <= 0x9fff || _0x4b5de8 >= 0x3040 && _0x4b5de8 <= 0x309f || _0x4b5de8 >= 0x30a0 && _0x4b5de8 <= 0x30ff || _0x4b5de8 >= 0xac00 && _0x4b5de8 <= 0xd7af)
                return _0x254e6c(0x1ce);
            else {
                if (_0x4b5de8 >= 0x0 && _0x4b5de8 <= 0x7f)
                    return _0x254e6c(0x222);
            }
        ...
        if (_0x51465e === 0x0)
            _0x589274[_0x4a7aba(0x204)] = 0.55,
            _0x589274[_0x4a7aba(0x208)] = 0.9;
        else
            _0x51465e === 0x1 && (_0x589274['fontScale'] = 0.65,
            _0x589274['spacingScale'] = 0x1);
        _0x22e78b > 0x0 && (_0x589274[_0x4a7aba(0x204)] *= 0.9,
        _0x589274[_0x4a7aba(0x208)] *= 1.1);
        ...
        (_0x16f1e7 < 0x1 || !_0x1f5a70) && (_0x1f5a70 = _0x34b47f,
        _0x16f1e7 = _0x314c89);
        const _0x4c0841 = document[_0x4a7aba(0x284)](_0x4a7aba(0x25d));
        _0x4c0841['width'] = Math[_0x4a7aba(0x205)](Math[_0x4a7aba(0x203)](0x1, _0x16f1e7)),
        _0x4c0841['height'] = _0x5aba38;
        ...
        _0x44b314['wrapS'] = _0x275f13[_0x4a7aba(0x239)],
        _0x44b314[_0x4a7aba(0x218)]['x'] = _0x16f1e7 / _0x23fecd,
        _0x44b314['needsUpdate'] = !![];
        const _0x462adf = new _0x275f13[(_0x4a7aba(0x20b))](_0x260e22,_0x260e22,0x1,0x80,0x1,!![])
          , _0x4efa79 = new _0x275f13[(_0x4a7aba(0x2b0))]({
            'map': _0x44b314,
            'transparent': !![],
        ...
        _0x56b67e[_0x4a7aba(0x1c8)][_0x4a7aba(0x223)](0x0, 0x0, 0x0),
        _0x56b67e[_0x4a7aba(0x2ad)]['y'] = Math['PI'] / 0x2;
        ...
        _0xd57ff4[_0x4a7aba(0x2ad)]['x'] = _0x901525,
        scene[_0x4a7aba(0x2a0)](_0xd57ff4),
        window['textRings'][_0x4a7aba(0x29a)](_0xd57ff4);
    }
}
createTextRings();
...
function createHintIcon() {
    ...
    hintIcon = new _0x275f13[(_0x3002e4(0x220))](),
    hintIcon[_0x3002e4(0x272)] = 'hint-icon-group',
    scene[_0x3002e4(0x2a0)](hintIcon);
    ...
    const _0x7ff399 = new _0x275f13[(_0x3002e4(0x23d))](_0x308965)
      , _0x33eb1a = new _0x275f13[(_0x3002e4(0x2b0))]({
        'color': 0xffffff,
        'side': _0x275f13[_0x3002e4(0x28f)]
    })
      , _0x571858 = new _0x275f13[(_0x3002e4(0x243))](_0x7ff399,_0x33eb1a)
      , _0x2583e7 = new _0x275f13[(_0x3002e4(0x23d))](_0x308965)
      , _0x5a3ef9 = new _0x275f13['MeshBasicMaterial']({
        'color': 0xffffff,
        'side': _0x275f13['DoubleSide']
    })
    ...
    const _0x3b72f5 = new _0x275f13[(_0x3002e4(0x27d))](1.8,0x2,0x20)
      , _0x3e90f7 = new _0x275f13['MeshBasicMaterial']({
        'color': 0xffffff,
        'side': _0x275f13[_0x3002e4(0x28f)],
        'transparent': !![],
        'opacity': 0.6
...
function animateHintIcon(_0x3d26c5) {
    ...
    if (!introStarted) {
        ...
        hintIcon[_0x1f9c08(0x298)](_0x4a7662),
        hintIcon[_0x1f9c08(0x1c8)][_0x1f9c08(0x1fa)](hintIcon[_0x1f9c08(0x271)][_0x1f9c08(0x1b3)])['addScaledVector'](_0x4a7662, -_0x20b1bb);
        ...
        hintText && (hintText[_0x1f9c08(0x1d4)] = !![],
...
function animate() {
    ...
    controls[_0x4f4f0e(0x25e)](),
    planet['material']['uniforms'][_0x4f4f0e(0x2b4)][_0x4f4f0e(0x2a2)] = _0x34a2bc * 0.5;
    ...
    scene[_0x4f4f0e(0x1ec)](_0xce253c => {
        ...
        if (_0xce253c[_0x2e847f(0x272)] === _0x2e847f(0x290)) {
            _0xce253c[_0x2e847f(0x274)] && _0xce253c['material']['opacity'] !== undefined && (_0xce253c[_0x2e847f(0x24a)][_0x2e847f(0x1b9)] = ![],
            _0xce253c['material'][_0x2e847f(0x1f3)] = 0x1);
            return;
        }
        if (_0xce253c[_0x2e847f(0x271)][_0x2e847f(0x246)] || _0xce253c[_0x2e847f(0x1fb)] && _0xce253c[_0x2e847f(0x1fb)][_0x2e847f(0x271)] && _0xce253c[_0x2e847f(0x1fb)][_0x2e847f(0x271)]['isTextRing'])
            _0xce253c[_0x2e847f(0x24a)] && _0xce253c[_0x2e847f(0x24a)][_0x2e847f(0x1f3)] !== undefined && (_0xce253c[_0x2e847f(0x24a)][_0x2e847f(0x1b9)] = ![],
            _0xce253c[_0x2e847f(0x24a)][_0x2e847f(0x1f3)] = 0x1),
            ...
            _0xce253c !== planet && _0xce253c !== centralGlow && _0xce253c !== hintIcon && _0xce253c[_0x2e847f(0x1de)] !== _0x2e847f(0x200) && !_0xce253c[_0x2e847f(0x1fb)][_0x2e847f(0x1f9)] && (_0xce253c[_0x2e847f(0x24a)] && _0xce253c['material'][_0x2e847f(0x1f3)] !== undefined && (_0xce253c['material']['transparent'] = !![],
            _0xce253c[_0x2e847f(0x24a)]['opacity'] = 0.1));
    }
    ),
    planet[_0x4f4f0e(0x1d4)] = !![],
    centralGlow[_0x4f4f0e(0x1d4)] = !![]) : scene[_0x4f4f0e(0x1ec)](_0x23cd39 => {
        const _0x538b9c = _0x4f4f0e;
        !(_0x23cd39['userData']['isTextRing'] || _0x23cd39['parent'] && _0x23cd39['parent'][_0x538b9c(0x271)] && _0x23cd39[_0x538b9c(0x1fb)][_0x538b9c(0x271)]['isTextRing'] || _0x23cd39 === planet || _0x23cd39 === centralGlow || _0x23cd39[_0x538b9c(0x1de)] === 'Scene') ? _0x23cd39['material'] && _0x23cd39[_0x538b9c(0x24a)][_0x538b9c(0x1f3)] !== undefined && (_0x23cd39['material'][_0x538b9c(0x1b9)] = !![],
        _0x23cd39[_0x538b9c(0x24a)]['opacity'] = fadeOpacity) : _0x23cd39['material'] && _0x23cd39[_0x538b9c(0x24a)][_0x538b9c(0x1f3)] !== undefined && (_0x23cd39[_0x538b9c(0x24a)][_0x538b9c(0x1f3)] = 0x1,
        _0x23cd39[_0x538b9c(0x24a)][_0x538b9c(0x1b9)] = ![]),
    ...
    for (let _0x1cca89 = shootingStars[_0x4f4f0e(0x236)] - 0x1; _0x1cca89 >= 0x0; _0x1cca89--) {
        ...
        let _0x412b7c = 0x1;
        if (_0x136677['userData'][_0x4f4f0e(0x209)] < 0x1e)
            _0x412b7c = _0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x209)] / 0x1e;
        else
            _0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x209)] > _0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x227)] - 0x1e && (_0x412b7c = (_0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x227)] - _0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x209)]) / 0x1e);
        ...
        if (_0x136677[_0x4f4f0e(0x271)][_0x4f4f0e(0x242)] > 0x1) {
            scene[_0x4f4f0e(0x289)](_0x136677),
            shootingStars[_0x4f4f0e(0x1af)](_0x1cca89, 0x1);
            continue;
        }
        ...
        _0x3a61c7[_0x4f4f0e(0x273)][_0x4f4f0e(0x293)](_0x257f32),
        _0x3a61c7[_0x4f4f0e(0x24a)][_0x4f4f0e(0x1f3)] = _0x412b7c * 0.7;
    }
    ...
    scene[_0x4f4f0e(0x1ec)](_0x279c1e => {
        ...
        if (_0x279c1e[_0x38436d(0x1f5)] && _0x279c1e[_0x38436d(0x271)]['materialNear'] && _0x279c1e['userData'][_0x38436d(0x27f)]) {
            ...
            _0x466d44 ? _0x279c1e[_0x38436d(0x24a)] !== _0x279c1e[_0x38436d(0x271)][_0x38436d(0x253)] && (_0x279c1e[_0x38436d(0x24a)] = _0x279c1e[_0x38436d(0x271)][_0x38436d(0x253)],
            _0x279c1e[_0x38436d(0x273)] = _0x279c1e[_0x38436d(0x271)][_0x38436d(0x26e)]) : _0x279c1e[_0x38436d(0x24a)] !== _0x279c1e[_0x38436d(0x271)]['materialFar'] && (_0x279c1e['material'] = _0x279c1e[_0x38436d(0x271)][_0x38436d(0x27f)],
            _0x279c1e[_0x38436d(0x273)] = _0x279c1e[_0x38436d(0x271)]['geometryFar']);
        }
    }
    ),
    planet[_0x4f4f0e(0x27a)](camera['position']),
    animatePlanetSystem(),
    starField && starField[_0x4f4f0e(0x24a)] && starField[_0x4f4f0e(0x24a)][_0x4f4f0e(0x1f3)] !== undefined && (starField[_0x4f4f0e(0x24a)][_0x4f4f0e(0x1f3)] = 0x1,
    starField[_0x4f4f0e(0x24a)][_0x4f4f0e(0x1b9)] = ![]),
...
function createHintText() {
    ...
    const _0x3371ab = new _0x275f13[(_0x13a126(0x2b0))]({
        'map': _0x37587a,
        'transparent': !![],
        'side': _0x275f13['DoubleSide']
    })
      , _0x14c212 = new _0x275f13['PlaneGeometry'](0x10,0x8);
    hintText = new _0x275f13[(_0x13a126(0x243))](_0x14c212,_0x3371ab),
    hintText[_0x13a126(0x1c8)][_0x13a126(0x223)](0x0, 0xf, 0x0),
    scene[_0x13a126(0x2a0)](hintText);
}
createShootingStar(),
createHintIcon(),
createHintText(),
    ...
    function _0x349f93() {
        ...
        if (_0x360509 < _0x40e78) {
            ...
            _0x3015fe = {
                ...
                'y': _0xed71fc['y'] + (_0x12f7c3['y'] - _0xed71fc['y']) * _0x1142e7,
            ...
            if (_0x360509 < _0x40e78 + _0x3cda7c) {
                ...
                _0x3015fe = {
                    ...
                    'y': _0x12f7c3['y'] + (_0x11f0f3['y'] - _0x12f7c3['y']) * _0x5d83a8,
                    'z': _0x12f7c3['z'] + (_0x11f0f3['z'] - _0x12f7c3['z']) * _0x5d83a8
                };
            } else {
                if (_0x360509 < _0x40e78 + _0x3cda7c + _0x33d32c) {
                    ...
                    _0x3015fe = {
                        ...
                        'y': _0x11f0f3['y'] + (_0xcee8e['y'] - _0x11f0f3['y']) * _0x251b94,
                        'z': _0x11f0f3['z'] + (_0xcee8e['z'] - _0x11f0f3['z']) * _0x251b94
                    };
                } else {
        ...
        camera['position'][_0x389f4b(0x223)](_0x3015fe['x'], _0x3015fe['y'], _0x3015fe['z']),
        camera[_0x389f4b(0x27a)](0x0, 0x0, 0x0),
...
function requestFullScreen() {
    ...
    if (_0x5a4ad7[_0x468f46(0x1ca)])
        _0x5a4ad7[_0x468f46(0x1ca)]();
    else {
        if (_0x5a4ad7['mozRequestFullScreen'])
            _0x5a4ad7['mozRequestFullScreen']();
        else {
            if (_0x5a4ad7[_0x468f46(0x21e)])
                _0x5a4ad7[_0x468f46(0x21e)]();
            else
                _0x5a4ad7['msRequestFullscreen'] && _0x5a4ad7['msRequestFullscreen']();
        }
    }
}
...
renderer[_0x207b43(0x28a)]['addEventListener'](_0x207b43(0x1b1), onCanvasClick),
animate(),
planet['name'] = _0x207b43(0x2a3),
centralGlow['name'] = _0x207b43(0x1c1);
...
document[_0x207b43(0x1bb)](_0x207b43(0x235), preventDefault, {
    'passive': ![]
}),
document[_0x207b43(0x1bb)]('gesturestart', preventDefault, {
    'passive': ![]
});
const container = document[_0x207b43(0x224)](_0x207b43(0x2b1));
container && container[_0x207b43(0x1bb)]('touchmove', preventDefault, {
    'passive': ![]
});
...
// --- Public API for easier manipulation ---
// Expose a small, clear API on window.galaxy to adjust common things without digging into internals
(() => {
    function removeTextRings() {
        if (!window.textRings) return;
        try {
            window.textRings.forEach(g => { try { scene.remove(g); } catch (e) {} });
        } catch (e) {}
        window.textRings = [];
    }
    ...
    function rebuildTextRings() {
        removeTextRings();
        try { createTextRings(); } catch (e) { /* ignore */ }
    }

    window.galaxy = {
        // Replace the text rings content and rebuild the rings
        setRingTexts(texts) {
            if (!Array.isArray(texts)) return;
            try {
                ringTexts.length = 0;
                ringTexts.push(...texts);
                rebuildTextRings();
            } catch (e) {}
        },

        // Trigger the intro sequence programmatically
        startIntro() {
            try { requestFullScreen && requestFullScreen(); } catch (e) {}
            try { startCameraAnimation && startCameraAnimation(); } catch (e) {}
            try {
                introStarted = true;
                fadeInProgress = true;
                if (starField && starField.geometry && typeof originalStarCount !== 'undefined') {
        ...
        setControlsEnabled(enabled) {
            try { controls.enabled = !!enabled; } catch (e) {}
        },
        focusPlanet() {
            try { controls.target.copy(planet.position); } catch (e) {}
        },

        // Stars and visual tweaks
        setStarOpacity(opacity) {
            ...
            try {
                ...
                if (!Number.isNaN(v)) starField.material.opacity = v;
            } catch (e) {}
        },
        triggerRipple() {
            try {
                if (galaxyMaterial && galaxyMaterial.uniforms && galaxyMaterial.uniforms.uRippleTime) {
                    galaxyMaterial.uniforms.uRippleTime.value = performance.now() * 0.001;
                }
            } catch (e) {}
        },
        setFogDensity(density) {
            try {
                if (scene.fog) scene.fog.density = Math.max(0, Number(density));
            } catch (e) {}
        }
    };
})();